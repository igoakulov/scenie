...
Scenie helps students, teachers and parents learn / teach visually. Tell your AI agent what you want to see - he'll use Scenie to do the rest! [Scenie](https://x.com/scenie_ai) stores everything on your device and does not collect data.

## Examples

Three example scenes from **real prompts** ([solar system prompt](https://github.com/igoakulov/scenie/blob/main/examples/example-showcase/metadata.json), [pendulum physics prompt](https://raw.githubusercontent.com/igoakulov/scenie/main/examples/example-homework/metadata.json), [linear algebra prompt](https://github.com/igoakulov/scenie/blob/main/examples/example-theory/metadata.json)). Included in the package your AI agent installs (see Install section).

![Example showcase: solar system](https://raw.githubusercontent.com/igoakulov/scenie/main/examples/screenshots/example-showcase.gif)
![Example homework: pendulum physics](https://raw.githubusercontent.com/igoakulov/scenie/main/examples/screenshots/example-homework.gif)
![Example theory: linear algebra](https://raw.githubusercontent.com/igoakulov/scenie/main/examples/screenshots/example-theory.gif)

More examples on [x.com/scenie_ai](https://x.com/scenie_ai)

## Who Scenie is for

**Teachers and students** - explore STEM subjects and concepts with fun interactive scenes, not lifeless drawings. Touch the subject, build intuition.

**Also useful for AI benchmarks and demos** - same tools for non-education showcases and side‑by‑side tests of AI models (not education-only).
...
2. **Open** - agent opens scene in **your browser**: scene library, side-by-side or fullscreen scene / summary.
3. **Play** - control camera, pause animations, experiment with **sliders & toggles** and watch the scene **update** in realtime.
...
- [x.com/scenie_ai](https://x.com/scenie_ai)
- [x.com/igoakulov](https://x.com/igoakulov)
